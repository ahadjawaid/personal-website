...
:::
:::
- Implemented and trained the WaveNet and Fastspeech 1/2 architectures from scratch for the generative speech task
- Trained FastSpeech 1/2 with to convergence in 80k steps less than the paper by normalizing target speech
- Designed, and documented novel framework to allow for quick experimentation with the FastSpeech model
- Conducted literature review of ~40 research papers relating to controllability of emotions in speech synthesis
